...
本文档定义了增材制造刷题工具的题库数据结构和导入格式规范。题库采用 JavaScript 模块格式，支持多种题型和丰富的元数据。
...
- 主题库文件：`src/questionBanks/[主题名称].js`
- 示例：`additiveManufacturing.js`、`additiveManufacturingAdvanced.js`
