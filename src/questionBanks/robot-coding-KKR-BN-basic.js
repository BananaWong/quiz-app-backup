// industrialRobot初级.js - 工业机器人应用编程职业技能等级理论知识考核题库（KKR-BN初级）

export const questionBank = [
  {
    id: 1,
    type: "single_choice",
    question: "手动操纵工业机器人运动一共有三种运动模式，下列（）不属于正确选项。",
    options: {
      A: "单轴运动",
      B: "线性运动",
      C: "重定位运动",
  ...
  },
  {
    id: 2,
    type: "single_choice",
    question: "工业机器人手动运行时，使能键按下为ON，松开为OFF，作为追加功能，用力过大时呈（）状态。",
    options: {
      A: "ON",
      B: "OFF",
      C: "报警",
  ...
  },
  {
    id: 3,
    type: "single_choice",
    question: "手动操作机器人的时候，机器人的速度与操纵杆的（）有关。",
    options: {
      A: "幅度",
      B: "大小",
      C: "颜色",
  ...
  },
  {
    id: 5,
    type: "single_choice",
    question: "手动操作机器人的时候，机器人的（）与操纵杆的幅度有关。",
    options: {
      A: "运动",
      B: "速度",
      C: "动作",
  ...
  },
  {
    id: 11,
    type: "single_choice",
    question: "工业机器人（）模式下，速度可调范围为1%-100%。",
    options: {
      A: "自动快速",
      B: "手动全速",
      C: "手动慢速",
  ...
  },
  {
    id: 12,
    type: "single_choice",
    question: "（）是指在不改变示教模式的前提下执行模拟再现动作的功能，机器人动作速度超过示教最高速度时，以示教最高速度来限制运行。",
    options: {
      A: "恒速运行",
      B: "低速运行",
      C: "全速运行",
  ...
  },
  {
    id: 13,
    type: "single_choice",
    question: "KUKA机器人有2种可以调节的倍率，其中程序倍率简称为（）。",
    options: {
      A: "POV",
      B: "HOV",
      C: "QOV",
  ...
  },
  {
    id: 14,
    type: "single_choice",
    question: "KUKA机器人状态栏中的\"提交解释器\"图标变为黄色，表示当前状态为（）。",
    options: {
      A: "选择了提交解释器",
      B: "提交解释器正在运行",
      C: "提交解释器被停止",
  ...
  },
  {
    id: 21,
    type: "single_choice",
    question: "KUKA机器人状态栏中的\"提交解释器\"图标变为绿色，表示当前状态为（）。",
    options: {
      A: "选择了提交解释器",
      B: "提交解释器正在运行",
      C: "提交解释器被停止",
  ...
  },
  {
    id: 23,
    type: "single_choice",
    question: "KUKA机器人状态栏中的\"提交解释器\"图标变为灰色，表示当前状态为（）。",
    options: {
      A: "选择了提交解释器",
      B: "提交解释器正在运行",
      C: "提交解释器被停止",
  ...
  },
  {
    id: 26,
    type: "single_choice",
    question: "通常用来定义机器人相对于其它物体的运动.与机器人通信的其它部件以及运动部件的参考坐标系是（）。",
    options: {
      A: "全局参考坐标系",
      B: "关节参考坐标系",
      C: "工具参考坐标系",
  ...
  },
  {
    id: 33,
    type: "single_choice",
    question: "机器人和不同的工作台或夹具配合工作，可以在每个工作台上建立（）。",
    options: {
      A: "世界坐标系",
      B: "基坐标系",
      C: "用户坐标系",
  ...
  },
  {
    id: 34,
    type: "single_choice",
    question: "调节工业机器人相应关节轴的运动角度，需要将坐标系类型切换至（）。",
    options: {
      A: "用户坐标系",
      B: "工具坐标系",
      C: "笛卡尔坐标系",
  ...
  },
  {
    id: 37,
    type: "single_choice",
    question: "在机器人学科里常用参考坐标系和（）来描述空间机器人的位姿。",
    options: {
      A: "工件坐标系",
      B: "世界坐标系",
      C: "关节坐标系",
  ...
  },
  {
    id: 42,
    type: "single_choice",
    question: "机器人可以拥有若干（），或者表示不同工件，或者表示同一工件在不同位置的若干副本。",
    options: {
      A: "关节坐标系",
      B: "工件坐标系",
      C: "求坐标系",
  ...
  },
  {
    id: 50,
    type: "single_choice",
    question: "调节工业机器人相应关节轴的运动角度，需要将（）切换至关节坐标系。",
    options: {
      A: "用户坐标系类型",
      B: "坐标系类型",
      C: "笛卡尔坐标系类型",
  ...
  },
  {
    id: 60,
    type: "single_choice",
    question: "当工业机器人坐标系切换到（），通过点动操作不能实现X.Y和乙三个方向移动。",
    options: {
      A: "工具坐标系",
      B: "工件坐标系",
      C: "关节坐标系",
  ...
  },
  {
    id: 62,
    type: "single_choice",
    question: "在KUKA机器人操作与编程过程中坐标系是非常重要的，其中（）坐标系在供货状态下与ROBROOT坐标系中一致。",
    options: {
      A: "WORLD",
      B: "BASE",
      C: "FLANGE",
  ...
  },
  {
    id: 71,
    type: "single_choice",
    question: "（）建立时，各个点位法兰盘位置必须相互且有很大不同。",
    options: {
      A: "工件坐标系",
      B: "笛卡尔坐标系",
      C: "关节坐标系",
  ...
  },
  {
    id: 72,
    type: "single_choice",
    question: "工业机器人在运行过程中，修改工具值的正确操作（）。",
    options: {
      A: "修改值并保存",
      B: "修改后激活",
      C: "不允许保存和激活",
  ...
  },
  {
    id: 100,
    type: "single_choice",
    question: "KUKA机器人程序运行方式有多种，当选择了（）方式，程序将不停顿地运行，直至程序结尾",
    options: {
      A: "GO",
      B: "动作",
      C: "单个步骤",
  ...
  },
  {
    id: 101,
    type: "single_choice",
    question: "KUKA机器人在测量基座时，用户要为工作面或工件指定一个（）。",
    options: {
      A: "工件坐标系",
      B: "笛卡尔坐标系",
      C: "工具坐标系",
  ...
  },
  {
    ...
    options: {
      A: "启动伺服—松开急停按钮—按下三段开关",
      B: "松开急停按钮—启动伺服—按下三段开关",
      C: "按下三段开关—松开急停按钮—启动伺服",
      D: "启动伺服—按下三段开关—松开急停按钮"
    },
    answer: "A",
    category: "安全操作"
  },
  {
    ...
    options: {
      A: "关闭伺服—按下急停按钮—松开三段开关",
      B: "按下急停按钮—关闭伺服—松开三段开关",
      C: "松开三段开关—按下急停按钮—关闭伺服",
      D: "关闭伺服—松开三段开关—按下急停按钮"
    },
    answer: "C",
    category: "安全操作"
  },
  ...
  },
  {
    id: 112,
    type: "single_choice",
    question: "因故离开工业机器人工作区域前应按下急停开关，避免突然断电或者关机零位丢失，并将示教器放置在安全位置。\nA.松开三段开关 \nB.按下急停开关\nC.关闭伺服 \nD.关闭示教器",
    options: {
      A: "松开三段开关",
      B: "按下急停开关",
      C: "关闭伺服",
  ...
  },
  {
    id: 114,
    type: "single_choice",
    question: "（）指连接在机器人末端法兰上的工具。也就是指机器人的手部。",
    options: {
      A: "末端执行器",
      B: "TCP",
      C: "工作空间",
  ...
  },
  {
    id: 134,
    type: "single_choice",
    question: "KUKA机器人有2种可以调节的倍率，其中手动倍率简称为（）。",
    options: {
      A: "POV",
      B: "HOV",
      C: "QOV",
  ...
  },
  {
    id: 135,
    type: "single_choice",
    question: "工业机器人一般需要（）个自由度才能使手部达到目标位置并处于期望的姿态。",
    options: {
      A: "3",
      B: "4",
      C: "6",
  ...
  },
  {
    id: 139,
    type: "single_choice",
    question: "KUKA机器人程序运行过程中必须最先运行的是（）。",
    options: {
      A: "DEF",
      B: "END",
      C: "INT",
  ...
  },
  {
    id: 142,
    type: "single_choice",
    question: "在手动加载工业机器人程序的过程中，一定要将机器人（）设为手动模式。",
    options: {
      A: "操作模式",
      B: "运动模式",
      C: "远程模式",
  ...
  },
  {
    id: 143,
    type: "single_choice",
    question: "选中相应的工业机器人程序，点击重命名按钮，可以将程序名字改为（）\n的组合。",
    options: {
      A: "字符和数字",
      B: "字母和数字",
      C: "字符和汉字",
  ...
  },
  {
    id: 160,
    type: "single_choice",
    question: "KUKA机器人程序运行方式有多种，当选择了（）方式，程序在每一运动组后暂停。",
    options: {
      A: "GO",
      B: "动作",
      C: "单个步骤",
  ...
  },
  {
    id: 161,
    type: "single_choice",
    question: "KUKA机器人程序运行方式有多种，当选择了（）方式，程序在每一程序行后暂停。",
    options: {
      A: "GO",
      B: "动作",
      C: "单个步骤",
  ...
  },
  {
    id: 162,
    type: "single_choice",
    question: "KUKA机器人程序运行方式有多种，当选择了（）方式，当按下逆向启动键时，则会自动选择这种程序运行方式。",
    options: {
      A: "GO",
      B: "动作",
      C: "单个步骤",
  ...
  },
  {
    id: 166,
    type: "single_choice",
    question: "在程序中需要新建一个用于表示0和1两张状态的变量，该变量类型为（）。",
    options: {
      A: "POINTC",
      B: "POINTJ",
      C: "BOOL",
  ...
  },
  {
    id: 177,
    type: "single_choice",
    question: "当KUKA机器人解释器状态显示为灰色，表示当前状态为（）。",
    options: {
      A: "未选定程序",
      B: "语句指针位于所选程序的首行",
      C: "已经选择程序，并运行完毕",
  ...
  },
  {
    id: 178,
    type: "single_choice",
    question: "当KUKA机器人解释器状态显示为黄色，表示当前状态为（）。",
    options: {
      A: "未选定程序",
      B: "语句指针位于所选程序的首行",
      C: "已经选择程序，并运行完毕",
  ...
  },
  {
    id: 179,
    type: "single_choice",
    question: "当KUKA机器人解释器状态显示为绿色，表示当前状态为（）。",
    options: {
      A: "未选定程序",
      B: "语句指针位于所选程序的首行",
      C: "已经选择程序，并运行完毕",
  ...
  },
  {
    id: 180,
    type: "single_choice",
    question: "当KUKA机器人解释器状态显示为红色，表示当前状态为（）。",
    options: {
      A: "未选定程序",
      B: "语句指针位于所选程序的首行",
      C: "已经选择程序，并运行完毕",
  ...
  },
  {
    id: 181,
    type: "single_choice",
    question: "当KUKA机器人解释器状态显示为黑色，表示当前状态为（）。",
    options: {
      A: "未选定程序",
      B: "语句指针位于所选程序的首行",
      C: "已经选择程序，并运行完毕",
  ...
  },
  {
    id: 182,
    type: "single_choice",
    question: "KUKA机器人有4种运动方式，其中（）用于程序验证。",
    options: {
      A: "T1和T2",
      B: "T1和AUT",
      C: "T2和AUT",
  ...
  },
  {
    id: 183,
    type: "single_choice",
    question: "KUKA机器人有4种运动方式，其中（）用于测试运行、编程和示教。",
    options: {
      A: "T1",
      B: "AUT",
      C: "T2",
  ...
  },
  {
    id: 184,
    type: "single_choice",
    question: "KUKA机器人有4种运动方式，其中（）用于不带上级控制系统的工业机器人。",
    options: {
      A: "T1",
      B: "AUT",
      C: "T2",
  ...
  },
  {
    id: 185,
    type: "single_choice",
    question: "KUKA机器人有4种运动方式，其中（）用于带有上级控制系统（例如PLC）的工业机器人。",
    options: {
      A: "T1",
      B: "AUT",
      C: "T2",
  ...
  },
  {
    id: 188,
    type: "single_choice",
    question: "对工业机器人进行系统备份，备份数据包括哪些内容（）。",
    options: {
      A: "IP",
      B: "机器人类型",
      C: "轴参数",
  ...
  },
  {
    id: 191,
    type: "single_choice",
    question: "KUKA机器人程序存储位置，有三个不同的USB存储位置可供选择，其中不正确的是（）。",
    options: {
      A: "USB(KCP)",
      B: "USB（控制柜）",
      C: "机器人数据下配置的网络",
  ...
  },
  {
    id: 192,
    type: "single_choice",
    question: "关于KUKA机器人示教器上的日志，说法错误的是（）。",
    options: {
  ...
  },
  {
    id: 194,
    type: "single_choice",
    question: "在KUKA机器人操作与编程过程中坐标系是非常重要的，其中（）固定位于机器人法兰上。",
    options: {
      A: "WORLD",
      B: "BASE",
      C: "FLANGE",
  ...
  },
  {
    id: 198,
    type: "single_choice",
    question: "KUKA机器人有4种运动方式，其中（）只能用于测试运行。",
    options: {
      A: "T1",
      B: "AUT",
      C: "T2",
  ...
  },
  {
    id: 199,
    type: "single_choice",
    question: "在KUKA机器人操作与编程过程中坐标系是非常重要的，其中（）固定位于机器人足部。",
    options: {
      A: "WORLD",
      B: "ROBROOT",
      C: "FLANGE",
  ...
  },
  {
    id: 200,
    type: "single_choice",
    question: "在KUKA机器人操作与编程过程中坐标系是非常重要的，其中（）是工具坐标系的参照点。",
    options: {
      A: "WORLD",
      B: "ROBROOT",
      C: "FLANGE",
  ...
  },
  {
    id: 201,
    type: "single_choice",
    question: "在KUKA机器人操作与编程过程中坐标系是非常重要的，其中（）的原点被称为TCP。",
    options: {
      A: "WORLD",
      B: "ROBROOT",
      C: "FLANGE",
  ...
  },
  {
    id: 202,
    type: "single_choice",
    question: "\"KUKA工业机器人程序存档位置可以是（）。\n$①\\mathrm{KCP}$  上的U盘；  $(2)$  机器人控制柜上的U盘；  $(3)$  网络\"",
    options: {
      A: "$①②③$",
      B: "①③",
      C: "②③",
  ...
  },
  {
    id: 203,
    type: "single_choice",
    question: "KUKA机器人操作模式中，用于测试运行、编程和示教的是（）。",
    options: {
      A: "T1",
      B: "T2",
      C: "AUT",
  ...
  },
  {
    id: 211,
    type: "single_choice",
    question: "通常对机器人进行示教编程时，要求最初程序点与最终程序点的位置（），可\n提高工作效率。",
    options: {
      A: "相同",
      B: "不同",
      C: "无所谓",
  ...
  },
  {
    id: 221,
    type: "single_choice",
    question: "工作人员操作示教盒在机器人工作区域范围内进行示教编程时，需要（）。",
    options: {
      A: "佩戴安全帽",
      B: "提高安全意识即可",
      C: "不用戴帽子",
  ...
  },
  {
    id: 223,
    type: "single_choice",
    question: "KUKA机器人进行示教编程时，常要对程序文件进行（）",
    options: {
      A: "无动作",
      B: "删除",
      C: "保存",
  ...
  },
  {
    id: 225,
    type: "single_choice",
    question: "在KUKA机器人程序文件中变量的存储类型不包括（）。",
    options: {
      A: "SRC",
      B: "DAT",
      C: "BOOL",
  ...
  },
  {
    id: 226,
    type: "single_choice",
    question: "KUKA机器人建立的程序模块始终放置在（）文件夹里。",
    options: {
      A: "AIR",
      B: "Program",
      C: "Main",
  ...
  },
  {
    id: 239,
    type: "single_choice",
    question: "KUKA工业机器人手动操作机器人运动有（）运动方式。",
    options: {
      A: "单轴运动",
      B: "线性运动",
      C: "重定位运动",
  ...
  },
  {
    id: 240,
    type: "single_choice",
    question: "KUKA机器人编程中常用于机器人空间大范围运动的指令是（）。",
    options: {
      A: "关节运动指令",
      B: "直线运动指令",
      C: "圆弧运动指令",
  ...
  },
  {
    id: 247,
    type: "single_choice",
    question: "KUKA机器人示教器中\"AUT\"指令的意思是（）。",
    options: {
      A: "自动运行",
      B: "手动低速",
      C: "手动高速",
  ...
  },
  {
    id: 249,
    type: "single_choice",
    question: "KUKA机器人示教编程器上的6D鼠标的作用为（）。",
    options: {
      A: "手动示教机器人",
      B: "调节机器人稳定性",
      C: "多余设置、没有作用",
  ...
  },
  {
    id: 255,
    type: "single_choice",
    question: "为使机器人进行正确的直线插补.圆弧插补等插补动作，需正确地输入焊枪、抓手、焊钳等工具的尺寸信息，定义控制点的位置。工具校验是可以简单和正确的进行尺寸信息输入的功能进行工具校验，需以控制点为基准示教4个不同的姿态。实践证明4个不同的姿态（）。",
    options: {
      A: "动作变化越大其工具控制点越精确",
      B: "动作变化越大其工具控制点越不精确",
      C: "动作变化越小其工具控制点越精确",
  ...
  },
  {
    id: 265,
    type: "single_choice",
    question: "KUKA机器人建立的一条圆弧指令需要几个点（）。",
    options: {
      A: "1个",
      B: "2个",
      C: "5个",
  ...
  },
  {
    id: 266,
    type: "single_choice",
    question: "KUKA机器人修改一条直线指令的最末点位置，可采用（）。",
    options: {
      A: "示教到该位置，修改记录位置参数",
      B: "删除程序文件，重头开始",
      C: "不用修改，依旧使用原来位置",
  ...
  },
  {
    id: 267,
    type: "single_choice",
    question: "当KUKA机器人示教器编程界面上面有一条完全相同的可以在当前编程处使用的指令时，最快的、最节省时间的操作是（）。",
    options: {
      A: "复制、粘贴相同的指令到此处",
      B: "重新写入一条指令",
      C: "复制、粘贴相似的指令，进行局部修改",
  ...
  },
  {
    id: 268,
    type: "single_choice",
    question: "KUKA机器人示教器编程界面上关于DEF KUKA_Prog说法正确的是（）。",
    options: {
  ...
  },
  {
    id: 269,
    type: "single_choice",
    question: "关于KUKA机器人说法错误的是（）。",
    options: {
      A: "程序最后的\"END\"表示程序结束",
      B: "\"INI\"行包含程序正确运行所需的标准参数的调用",
      C: "\"INI\"行必须最先运行",
      D: "KUKA机器人示教器只有唯一的一个使能键"
    },
    answer: "D",
    category: "KUKA机器人操作"
  },
  {
    id: 270,
    type: "single_choice",
    question: "与常见的文件系统类似，也可以在KUKA smartPad导航器中编辑程序模块，编辑方式不包括（）。",
    options: {
      A: "复制",
      B: "删除",
      C: "改名",
  ...
  },
  {
    id: 317,
    type: "single_choice",
    question: "将控制系统中输出信号(如速度.位置)的部分或全部通过一定方式，加送到输\n入端，并与输入信号叠加，从而可改善系统的性能，这一过程称为（）。",
    options: {
      A: "检测",
      B: "反馈",
      C: "控制",
  ...
  },
  {
    id: 346,
    type: "single_choice",
    question: "电感式传感器的特点是（）。\n$①$  抗干扰能力强；  $(2)$  对环境要求不高；  $(3)$  分辨率高；  $(\\underline{4})$  适合用于快速动态测量",
    options: {
      A: "②③④",
      B: "①③④",
      C: "①②③",
  ...
  },
  {
    id: 349,
    type: "single_choice",
    question: "电容式传感器的特点是（）。\n$①$  阻抗高；  $(2)$  灵敏度高；  $(3)$  结构简单，轻巧易于制造；  $(4)$  负载能力强",
    options: {
      A: "$①②③④$",
      B: "①②",
      C: "②③④",
  ...
  },
  {
    id: 351,
    type: "single_choice",
    question: "一个理想的湿度传感器，应该具有的特征是（）。\n$①$  寿命长，  $(2)$  稳定性好；  $(3)$  灵敏度高；  $(4)$  测量范围宽；  $(5)$  响应时间短",
    options: {
      A: "$①②③④⑤$",
      B: "③④5",
      C: "②③④5",
  ...
  },
  {
    id: 354,
    type: "single_choice",
    question: "温度传感器中用于测量温度的热电阻材料应该具有的特征为（）。\n$①$  高温度系数，高电阻率；  $(2)$  物理化学性能稳定；  $(3)$  电阻随温度线性变化；  $(4)$  抗高温氧化",
    options: {
      A: "$①②③$",
      B: "①②③④",
      C: "①③④",
  ...
  },
  {
    id: 359,
    type: "single_choice",
    question: "光纤传感器与传统传感器比较，优缺点有（）  $①$  抗电磁干扰弱；  $(2)$  耐腐蚀； $(3)$  电绝缘性好；  $(4)$  防燃防爆",
    options: {
      A: "②③④",
      B: "①③④",
      C: "①②④",
  ...
  },
  {
    id: 386,
    type: "single_choice",
    question: "（）是由电子计算机进行管理和控制的，不需要人工搬运作业而实现收发\n作业的仓库。",
    options: {
      A: "仓库",
      B: "自动化仓库",
      C: "立体仓库",
  ...
  },
  {
    id: 395,
    type: "single_choice",
    question: "（）具有检测距离长.不受检测物体的制约、响应速度快、镜头容易受有机\ndust等的影响，受环境强光的影响等特点。",
    options: {
      A: "对射式光电开关",
      B: "漫反射光电开关",
      C: "槽型光电开关",
  ...
  },
  {
    id: 408,
    type: "single_choice",
    question: "ABB机器人中WaitTime4，其中4指的是（）。",
    options: {
      A: "4s",
      B: "4min",
      C: "4h",
  ...
  },
  {
    id: 418,
    type: "single_choice",
    question: "早期的工业机器人采用液压、气动的方式进行伺服驱动，但是现在仍然采用液压、气动的场合原因是液压、气动（）。\n$①$  输出功率高、  $(2)$  防爆性能好、  $(3)$  运动精度要求低、  $(4)$  响应快",
    options: {
      A: "$①②③$",
      B: "①②④",
      C: "②③④",
  ...
  },
  {
    id: 420,
    type: "single_choice",
    question: "在 KUKA 机器人进行手动示教搬运、码垛时，需要将机器人运动模式调到（）。",
    options: {
      A: "T1",
      B: "T2",
      C: "aut",
  ...
  },
  {
    id: 422,
    type: "single_choice",
    question: "（）直接指定操作内容，机器人必须一边思考一边工作，这是一种水平很高的机器人程序语言。",
    options: {
      A: "任务级语言",
      B: "对象级语言",
      C: "动作级语言",
  ...
  },
  {
    id: 425,
    type: "single_choice",
    question: "（）是采用比母材熔点低的金属材料做钎料，利用液态钎料润湿母材，填充接头间隙，并与母材互相扩散实现链接焊件。",
    options: {
      A: "熔焊",
      B: "压焊",
      C: "钎焊",
  ...
  },
  {
    id: 432,
    type: "single_choice",
    question: "工业机器人在搬运工艺中，抓取点、过度点、放置点的末端执行器状态为（）。",
    options: {
      A: "抓取点：手抓放开",
      B: "过度点：手抓闭合、并状态保持",
      C: "放置点：手抓闭合",
  ...
  },
  {
    id: 440,
    type: "single_choice",
    question: "KUKA机器人程序存档路径有（）。\n$①$  USB(KCP)|KCP(smardPAD）上的U盘，  $(2)$  USB（控制柜）丨机器人控制柜上的U盘，  $(3)$  网络|在一个网络路径上存档",
    options: {
      A: "$①③$",
      B: "②③",
      C: "①②",
  ...
  },
  {
    id: 441,
    type: "single_choice",
    question: "KUKA机器人人进行编辑焊接程序时涉及ARCON是指（）。",
    options: {
      A: "焊接起弧",
      B: "关闭电弧",
      C: "维持电弧",
  ...
  },
  {
    id: 442,
    type: "single_choice",
    question: "KUKA机器人进行编辑焊接程序时涉及ARCOF是指（）。",
    options: {
      A: "焊接起弧",
      B: "关闭电弧",
      C: "维持电弧",
  ...
  },
  {
    id: 443,
    type: "single_choice",
    question: "KUKA机器人进行编辑焊接程序时涉及ARCSWITCH是指（）。",
    options: {
      A: "焊接起弧",
      B: "关闭电弧",
      C: "维持电弧",
  ...
  },
  {
    id: 448,
    type: "single_choice",
    question: "KUKA机器人程序的运行方式主要有（）。\n$①\\mathrm{GO}$  ，  $(2)$  MSTEP，  $(3)$  ISTEP",
    options: {
      A: "$①③$",
      B: "②③",
      C: "①②",
  ...
  },
  {
    id: 460,
    type: "single_choice",
    question: "存在高度触电危险的环境以及特别潮湿的场所应采用的安全电压为（）。",
    options: {
      A: "36V",
      B: "24V",
      C: "12V",
  ...
  },
  {
    id: 471,
    type: "single_choice",
    question: "与法律相比，道德在调控人与人.人与社会以及人与自然之间的各种关系时，\n它的（）。",
    options: {
      A: "时效性差",
      B: "作用力弱",
      C: "操作性强",
  ...
  },
  {
    id: 489,
    type: "true_false",
    question: "工业机器人控制柜处于自动模式模式时，可进行手动操作。",
    answer: "false",
    category: "工业机器人基础"
  },
  {
  ...
  },
  {
    id: 494,
    type: "true_false",
    question: "KUKA工业机器人只有将控制柜打到手动减速模式才可以进行语言设置。",
    answer: "true",
    category: "KUKA机器人操作"
  },
  {
    id: 495,
    type: "true_false",
    question: "非手动模式下，KUKA机器人允许操作人员进行系统信息修改。",
    answer: "false",
    category: "KUKA机器人操作"
  },
  {
    id: 496,
    type: "true_false",
    question: "机器人工具被更换，重新定义TCP后，可以不更改程序，直接运行。",
    answer: "true",
    category: "工业机器人工具"
  },
  {
  ...
  },
  {
    id: 498,
    type: "true_false",
    question: "在机器人坐标系中，可以进行六个轴的移动操作。",
    answer: "false",
    category: "工业机器人坐标系"
  },
  {
  ...
  },
  {
    id: 503,
    type: "true_false",
    question: "机器人学中，任一刚体的位置、姿态由其上任一基准点（通常选作物体的质心）和过该点的坐标系相对于参考系的相对关系来确定。",
    answer: "true",
    category: "机器人学基础"
  },
  {
  ...
  },
  {
    id: 515,
    type: "true_false",
    question: "KUKA 工业机器人编辑程序包括两个方面，一方面是程序指令的操作，另一方面是程序变量的操作。",
    answer: "true",
    category: "KUKA机器人编程"
  },
  {
    id: 516,
    type: "true_false",
    question: "KUKA 工业机器人在文件管理器界面，新建或者加载一个程序，示教器界面会自动跳转到程序编辑器界面。",
    answer: "true",
    category: "KUKA机器人编程"
  },
  {
  ...
  },
  {
    id: 521,
    type: "true_false",
    question: "对 KUKA 工业机器人进行示教编程，必须先建立新的变量，才能记录示教点位置信息。",
    answer: "false",
    category: "KUKA机器人编程"
  },
  {
    id: 522,
    type: "true_false",
    question: "对 KUKA 工业机器人进行示教编程，可以直接使用相同速度编程。",
    answer: "false",
    category: "KUKA机器人编程"
  },
  {
    id: 523,
    type: "true_false",
    question: "通过示教编程对 KUKA 工业机器人程序做姿态参数修整，应将机器人坐标系设置为-笛卡尔坐标系。",
    answer: "false",
    category: "KUKA机器人编程"
  },
  {
    id: 524,
    type: "true_false",
    question: "对 KUKA 工业机器人进行系统程序参数数据备份，仅需备份所有存储在 Home 目录下的文件和文件即可。",
    answer: "false",
    category: "KUKA机器人系统"
  },
  {
    id: 525,
    type: "true_false",
    question: "KUKA 工业机器人备份的对象是所有正在系统内存运行的 RAPID 程序和系统参数。",
    answer: "true",
    category: "KUKA机器人系统"
  },
  {
    id: 526,
    type: "true_false",
    question: "KUKA工业机器人在恢复过程中，所有的系统参数被替换，并且所有的备份目录下的模块被重新装载。",
    answer: "true",
    category: "KUKA机器人系统"
  },
  {
    id: 527,
    type: "true_false",
    question: "KUKA工业机器人示教器可以随时插U盘导入导出程序。",
    answer: "true",
    category: "KUKA机器人操作"
  },
  {
  ...
  },
  {
    id: 535,
    type: "true_false",
    question: "为了确保安全，用示教编程器手动运行机器人时，机器人的最高速度限制是 $200\\mathrm{mm / s}$ 。",
    answer: "false",
    category: "工业机器人安全"
  },
  {
    id: 536,
    type: "true_false",
    question: "条件比较指令包括寄存器条件比较指令和I/O条件比较指令。",
    answer: "true",
    category: "工业机器人编程"
  },
  {
  ...
  },
  {
    id: 541,
    type: "true_false",
    question: "KUKA机器人示教编程器样条运动的含义为目标点被轨迹逼近。",
    answer: "true",
    category: "KUKA机器人编程"
  },
  {
    id: 542,
    type: "true_false",
    question: "点到点运动是机器人沿最快的轨道将TCP从起始点引至目标点。",
    answer: "true",
    category: "机器人运动"
  },
  {
    id: 543,
    type: "true_false",
    question: "线性运动是机器人沿一条直线以定义的速度将TCP引至目标点。",
    answer: "true",
    category: "机器人运动"
  },
  {
    id: 544,
    type: "true_false",
    question: "编写工业机器人圆弧轨迹时至少需要3个示教点位。",
    answer: "true",
    category: "工业机器人编程"
  },
  {
  ...
  },
  {
    id: 546,
    type: "true_false",
    question: "KUKA机器人示教器上的日志可随意自由删除。",
    answer: "false",
    category: "KUKA机器人操作"
  },
  {
    id: 547,
    type: "true_false",
    question: "具备6个自由度的KUKA机器人具有1个不同的奇点位置。",
    answer: "false",
    category: "KUKA机器人结构"
  },
  {
  ...
  },
  {
    id: 559,
    type: "true_false",
    question: "在一瞬间时，两个同频率正弦交流电的相位之差叫做相位差。",
    answer: "true",
    category: "电气基础"
  },
  {
  ...
  },
  {
    id: 571,
    type: "true_false",
    question: "工业机器人根据所完成的任务的不同，配置的传感器类型和规格也不相同，一般分为内部信息传感器.外部信息传感器。",
    answer: "true",
    category: "工业机器人传感器"
  },
  {
  ...
  },
  {
    id: 579,
    type: "true_false",
    question: "我国的机器人专家从应用环境出发，将机器人分为两大类，即工业机器人和服务机器人。",
    answer: "true",
    category: "机器人分类"
  },
  {
  ...
  },
  {
    id: 582,
    type: "true_false",
    question: "机器人终端效应器（手）的力量来自机器人的全部关节。",
    answer: "false",
    category: "机器人结构"
  },
  {
  ...
  },
  {
    id: 584,
    type: "true_false",
    question: "夹持式手部分为三种：分别是夹钳式、弹簧式、钩拖式。",
    answer: "true",
    category: "机器人末端执行器"
  },
  {
  ...
  },
  {
    id: 587,
    type: "true_false",
    question: "搬运机器人的TCP点，一般吸盘类设置在法兰中心线与吸盘底面的交点处，而夹钳类通常设置在法兰中心线与手爪前端面的交点处。",
    answer: "true",
    category: "工业机器人工具"
  },
  {
    id: 588,
    type: "true_false",
    question: "原点位置校准是将机器人位置与绝对编码器位置进行对照的操作。原点位置校准是在出厂前进行的，但在改变机器人与控制柜的组合情况下必须再次进行原点位置校准。",
    answer: "true",
    category: "工业机器人维护"
  },
  {
  ...
  },
  {
    id: 593,
    type: "true_false",
    question: "对我国传统课堂影响至深的是前苏联教育家凯洛夫的“五段式”。",
    answer: "true",
    category: "教育理论"
  },
  {
  ...
  },
  {
    id: 595,
    type: "true_false",
    question: "我国古代最早运用比较文学方法研究文学作品的论著是《红楼梦评论》，作者是王国维。",
    answer: "true",
    category: "文学理论"
  },
  {
